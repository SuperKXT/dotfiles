...
# simple update alias
alias update='sudo apt update && sudo apt full-upgrade -y --allow-downgrades --fix-missing && sudo apt autoremove && snap refresh && flatpak update && nvm use lts/* && npm-check -gu && nvm use node && npm-check -gu && nvm use default'
